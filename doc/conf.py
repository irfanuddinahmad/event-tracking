...
htmlhelp_basename = "event-trackingdoc"
...
man_pages = [
    ("index", "event-tracking", "event-tracking Documentation", ["edX.org"], 1)
]
...
os.environ["DJANGO_SETTINGS_MODULE"] = "eventtracking.django.tests"
